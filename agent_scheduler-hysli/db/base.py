...
if hasattr(shared.cmd_opts, "agent_scheduler_hysli_sqlite_file"):
    # if relative path, join with basedir
    if not os.path.isabs(shared.cmd_opts.agent_scheduler_hysli_sqlite_file):
        db_file = os.path.join(scripts.basedir(), shared.cmd_opts.agent_scheduler_hysli_sqlite_file)
    else:
